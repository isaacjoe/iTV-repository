Device Information
=================
<a href="https://platform.telerik.com/#appbuilder/clone/https%3A%2F%2Fgithub.com%2FIcenium%2Fsample-deviceinfo" target="_blank"><img src="http://docs.telerik.com/platform/samples/images/try-in-appbuilder.png" alt="Try in AppBuilder" title="Try in AppBuilder" /></a>  
...
This sample shows how to use the Device core plugin to obtain information about the software and hardware of a device.
...
Platform | Home
---|---
All | ![](https://raw.githubusercontent.com/Icenium/sample-deviceinfo/master/screenshots/home.png)
...
1. Run the clone command for the sample as listed by `appbuilder sample`.
	...
	```bash
	appbuilder sample clone deviceinfo
	```
